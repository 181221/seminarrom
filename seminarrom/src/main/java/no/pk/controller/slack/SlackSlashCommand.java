...
import no.pk.bot.models.Attachment;
import no.pk.bot.models.RichMessage;
...
public class SlackSlashCommand {
     ...
     * then bot sends a POST request to this endpoint. So, this endpoint
    ...
    public RichMessage onReceiveSlashCommand(@RequestParam("token") String token,
        ...
        if (!token.equals(slackToken)) {
            return new RichMessage("Sorry! You're not lucky enough to use our bot command.");
        }
