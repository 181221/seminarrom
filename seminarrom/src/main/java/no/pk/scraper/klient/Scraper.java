package no.pk.scraper.klient;

import no.pk.scraper.util.RomUtil;
...
import static no.pk.scraper.model.Mail.TILMAIL;
import static no.pk.scraper.util.CsvReaderUtil.readCSVInternett;
import static no.pk.scraper.util.MailUtil.setUpMail;
...
public class Scraper {
    ...
    private static final String DRIVER_LOKAL = "D:\\Utvikling\\Ressurser\\Java\\chromedriver\\chromedriver.exe";
