...
public abstract class Bot {
    ...
    public final void handleTextMessage(WebSocketSession session, TextMessage textMessage) throws Exception {
        ...
        try {
            ...
            } else { // bot does not send any TYPE for acknowledgement messages
    ...
    /**
     * Check whether a conversation is up in a particular bot channel.
     *
     * @param event
     ...
     * match with bot message received ({@link Event#text}) for cases where there are no matched methods.
     *
     * @param event
     * @param methodWrappers
     * @return the MethodWrapper whose method pattern match with that of the bot message received, {@code null} if no
